  ...
  <div class="indicator-panel">
    <div class="indicator-header">
      ...
      <div class="indicator-controls">
        <n-button text @click="onToggleVisibility">
          {{ indicator.visible === false ? 'Show' : 'Hide' }}
        </n-button>
        <n-button text @click="onResetParameters">Reset</n-button>
...
export default {
  ...
  methods: {
    ...
    onToggleVisibility() {
      this.$emit('toggle-visibility', this.indicator.id);
    },

    onResetParameters() {
      this.$emit('reset-parameters', this.indicator.id);
    },
  },
};
</script>
